...
class TestGetFarmUseCase:
    ...
    # - test_get_farm_success
    # - test_get_farm_not_found
    # - test_get_farm_no_permission
    # - test_get_farm_user_service_error
    # - test_get_farm_database_error
    # - test_get_farm_missing_active_states
